...
ticl_sim.toModify(ticlSimTrackstersTask, func=lambda x : x.add(simHitTPAssocProducer, trackingParticleRecoTrackAsssociation, lcAssocByEnergyScoreProducer, layerClusterCaloParticleAssociationProducer, scAssocByEnergyScoreProducer, layerClusterSimClusterAssociationProducer))
