...
void TICLDumper::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.add<std::vector<edm::InputTag>>("label_rechits", std::vector<edm::InputTag>{{edm::InputTag("HGCalRecHit:HGCEERecHits"),
                                                                                    edm::InputTag("HGCalRecHit:HGCHEFRecHits"),
                                                                                    edm::InputTag("HGCalRecHit:HGCHEBRecHits")}});
  desc.add<std::vector<edm::InputTag>>("label_simhits", std::vector<edm::InputTag>{{edm::InputTag("g4SimHits:HGCHitsEE"),
