#ifndef RecoHGCal_TICL_MCFInterpretationAlgo_H
#define RecoHGCal_TICL_MCFInterpretationAlgo_H
...
private:
  ...
  float computeScore(float refPt, float refEta, float refPhi, float refP,
