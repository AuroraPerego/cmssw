...
#ifndef RecoTICL_LinkingProducers_TracksterLinkingSuperClusteringMustache_H
#define RecoTICL_LinkingProducers_TracksterLinkingSuperClusteringMustache_H
...
#include "RecoTICL/LinkingProducers/interface/SuperclusteringDNNInputs.h"
