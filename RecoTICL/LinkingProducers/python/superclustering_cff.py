...
from RecoTICL.LinkingProducers.ticlEGammaSuperClusterProducer_cfi import ticlEGammaSuperClusterProducer
...
ticlTracksterLinksSuperclusteringDNN = _tracksterLinksProducer.clone(
    linkingPSet = cms.PSet(
        ...
        onnxModelPath = cms.FileInPath("RecoTICL/LinkingProducers/data/superclustering/supercls_v2p1.onnx"),
