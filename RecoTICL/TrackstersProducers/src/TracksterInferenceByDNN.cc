...
#include "RecoTICL/TrackstersProducers/interface/TracksterInferenceByDNN.h"
#include "RecoTICL/TrackstersProducers/interface/TracksterInferenceAlgoFactory.h"
  ...
  void TracksterInferenceByDNN::fillPSetDescription(edm::ParameterSetDescription& iDesc) {
    ...
    iDesc
        .add<edm::FileInPath>("onnxPIDModelPath",
                              edm::FileInPath("RecoTICL/TrackstersProducers/data/ticlv5/onnx_models/patternrecognition/id_v0.onnx"))
        ->setComment("Path to ONNX PID model CLU3D");
    iDesc
        .add<edm::FileInPath>(
            "onnxEnergyModelPath",
            edm::FileInPath("RecoTICL/TrackstersProducers/data/ticlv5/onnx_models/patternrecognition/energy_v0.onnx"))
