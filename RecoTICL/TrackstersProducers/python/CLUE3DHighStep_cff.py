...
ticlTrackstersCLUE3DHigh = _trackstersProducer.clone(
    ...
    pluginInferenceAlgoTracksterInferenceByCNNv4 = cms.PSet(
        ...
        onnxModelPath = cms.FileInPath('RecoTICL/TrackstersProducers/data/ticlv4/onnx_models/energy_id_v0.onnx'),
    ...
    pluginInferenceAlgoTracksterInferenceByDNN = cms.PSet(
        algo_verbosity = cms.int32(0),
        onnxPIDModelPath = cms.FileInPath('RecoTICL/TrackstersProducers/data/ticlv5/onnx_models/patternrecognition/id_v0.onnx'),
        onnxEnergyModelPath = cms.FileInPath('RecoTICL/TrackstersProducers/data/ticlv5/onnx_models/patternrecognition/energy_v0.onnx'),
